    ...
    <section className="events container">
      ...
      <div className="accordion">
        <div className={`accordion__item ${activeItem === 1 ? '' : 'item-hidden'}`}>
          <button className="accordion__info" type="button" onClick={() => handleAccordionClick(1)}>
        ...
        <div className={`accordion__item ${activeItem === 2 ? '' : 'item-hidden'}`}>
          <button className="accordion__info" type="button" onClick={() => handleAccordionClick(2)}>
        ...
        <div className={`accordion__item ${activeItem === 3 ? '' : 'item-hidden'}`}>
          <button className="accordion__info" type="button" onClick={() => handleAccordionClick(3)}>
        ...
        <div className={`accordion__item ${activeItem === 4 ? '' : 'item-hidden'}`}>
          <button className="accordion__info" type="button" onClick={() => handleAccordionClick(4)}>
        ...
        <div className={`accordion__item ${activeItem === 5 ? '' : 'item-hidden'}`}>
          <button className="accordion__info" type="button" onClick={() => handleAccordionClick(5)}>
            <div className="accordion__info-title">Hawaiian party</div>
        ...
        <div className={`accordion__item ${activeItem === 6 ? '' : 'item-hidden'}`}>
          <button className="accordion__info" type="button" onClick={() => handleAccordionClick(6)}>
        ...
        <div className={`accordion__item ${activeItem === 7 ? '' : 'item-hidden'}`}>
          <button className="accordion__info" type="button" onClick={() => handleAccordionClick(7)}>
        ...
        <div className={`accordion__item ${activeItem === 8 ? '' : 'item-hidden'}`}>
          <button className="accordion__info" type="button" onClick={() => handleAccordionClick(8)}>
